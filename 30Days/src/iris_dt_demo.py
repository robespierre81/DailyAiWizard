# Complex demo: Load Iris, preprocess, fit decision tree classifier, classify, evaluate, visualize with Matplotlib/Seaborn
import pandas as pd
import numpy as np
...
def iris_dt_demo():
    ...
    plt.title('Decision Tree: Iris Predictions')

# Complex demo: Load Iris, preprocess, fit random forest classifier, predict, evaluate, visualize with Matplotlib/Seaborn
import pandas as pd
import numpy as np
...
def iris_rf_demo():
    ...
    plt.title('Random Forest: Iris Predictions')
    ...
    plot_tree(model.estimators_[0], feature_names=X.columns, class_names=iris.target_names, filled=True)

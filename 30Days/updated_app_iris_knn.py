# Demo: Updated flower classification component for AI Insight Hub app using Streamlit and KNN
...
def updated_iris_knn_app():
    st.header("Iris Flower Classification with KNN")
    # Load data for demo
    iris = load_iris()
    ...
    joblib.dump(scaler, 'iris_knn_scaler.pkl')
    # User input
